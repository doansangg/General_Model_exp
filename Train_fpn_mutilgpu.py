...
def train(train_loader, model, optimizer, epoch, test_path):
    ...
    for i, pack in enumerate(train_loader, start=1):
        for rate in size_rates:
            ...
            lateral_map_6 = model(images)
            # print(lateral_map_6.shape)
            # print(gts.shape)
            # test output
            ...
            loss5 = structure_loss(lateral_map_6, gts)
    ...
    if (epoch+1) % 1 == 0:
        ...
        if meandice > best:
            best = meandice
            torch.save(model.state_dict(), save_path + 'HarD-MSEG-test_1.pth' )
            print('[Saving Snapshot:]', save_path + 'HarD-MSEG-test_1.pth',meandice)
